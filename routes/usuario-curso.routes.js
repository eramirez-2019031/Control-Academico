...
const { usuarioCursoPost, usuarioCursoGet, getUsuarioCursoByid, usuarioCursoDelete } = require('../controllers/usuario-curso');
...
router.post(
    "/", 
    [
        check("email","El estudiante es obligatorio").not().isEmpty(),
